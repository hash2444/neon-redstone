# Neon Redstone - Setup help

Everything you need to get **Neon Redstone** running, step by step. If something goes wrong, check *Troubleshooting* at the end.
...
- Nothing to configure: activate the **resource pack** in your world (or globally under *Settings -> Global Resources*) and look at your redstone.
